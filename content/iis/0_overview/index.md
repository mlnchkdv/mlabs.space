...
{{< admonition abstract "[Intro] Введение в ИИС и выравнивание знаний." false >}}
...
{{< admonition abstract "[Algo] Алгоритмизация стратегий и решений для разработки ИИС." false >}}
...
{{< admonition abstract "[ML] Классификация и описание моделей и их метрик в машинном обучении." false >}}
...
{{< admonition abstract "[NLP] Техники и Модели обработки естественного языка (NLP)." false >}}
...
{{< admonition abstract "[LLM] Большие языковые модели (LLM) для ИИС." false >}}
...
$$
\bf{\text{Grade}} = \frac{\left [ \text{Project} + \text{Test} + \text{Exam} + \text{Other} \right ] \cdot \text{Rate}}{450} \cdot 100
$$
