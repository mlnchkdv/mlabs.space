...
- **Роли в команде**: 
  - <button class="role-button">Разработчик бэкенда</button> 🖥️
  - <button class="role-button">Разработчик фронтенда</button> 🎨
  - <button class="role-button">Аналитик данных</button> 📊
  - <button class="role-button">Тестировщик/менеджер проекта</button> ✅
...
- **Роли в команде**:
  ...
  - <button class="role-button">Разработчик фронтенда</button> 🎨
  - <button class="role-button">Аналитик данных</button> 📊
  - <button class="role-button">UX/UI дизайнер</button> 🎨
...
- **Роли в команде**:
  - <button class="role-button">Разработчик бота</button> 🤖
  - <button class="role-button">Разработчик API-интеграции</button> 🌐
  - <button class="role-button">Тестировщик/контент-менеджер</button> ✅
  - <button class="role-button">UX/UI дизайнер</button> 🎨
...
- **Роли в команде**:
  ...
  - <button class="role-button">Разработчик фронтенда</button> 🎨
  - <button class="role-button">Аналитик данных</button> 📊
  - <button class="role-button">Менеджер проекта/тестировщик</button> ✅
...
- **Роли в команде**:
  - <button class="role-button">Разработчик бэкенда</button> 🖥️
  - <button class="role-button">Разработчик фронтенда</button> 🎨
  - <button class="role-button">Тестировщик</button> ✅
  - <button class="role-button">UX/UI дизайнер</button> 🎨
...
- **Системные характеристики**: CPU с 2 ядрами, 4 ГБ ОЗУ, 10 ГБ свободного места на диске
- **Роли в команде**:
  - <button class="role-button">Разработчик API</button> 🌐
  - <button class="role-button">Разработчик фронтенда</button> 🎨
  - <button class="role-button">Менеджер контента</button> 📚
  - <button class="role-button">UX/UI дизайнер</button> 🎨
...
- **Описание**: Приложение, которое помогает учить новые слова и фразы,

 используя флэш-карты и мини-тесты.
...
- **Роли в команде**:
  - <button class="role-button">Разработчик бэкенда</button> 🖥️
  - <button class="role-button">Разработчик фронтенда</button> 🎨
  - <button class="role-button">Контент-менеджер</button> 📚
  - <button class="role-button">Тестировщик</button> ✅
