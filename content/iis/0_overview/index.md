...
radar:
  indicator:
    ...
    - name: Анализ данных и обучение моделей
      max: 15
    - name: Интерфейс и пользовательский опыт (UX/UI)
      max: 10
    - name: Документация и презентация проекта
      max: 5
    - name: Инновационность и оригинальность решения
...
series:
  - name: Оценка проекта
    ...
    data:
      - value:
          - 18  # Высокая оценка за реализацию и полноту проекта
          - 5   # Низкое качество кода и архитектуры
          - 19  # Хорошее использование технологий и моделей
          - 8   # Средний анализ данных и обучение моделей
          - 2   # Очень низкий UX/UI
          - 3   # Плохая документация и презентация
          - 9   # Высокая инновационность
          - 4   # Средняя командная работа и организация процесса
        name: Проект A
    areaStyle: {}
