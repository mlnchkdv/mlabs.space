...
Научить студентов-экономистов анализировать глобальные экономические события и тенденций, развить навыки работы с большими данными используя открытые данные из базы GDELT.
